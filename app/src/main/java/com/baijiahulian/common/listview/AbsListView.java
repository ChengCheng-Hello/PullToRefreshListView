 ...
 */
public class AbsListView extends CoordinatorLayout {
    ...
    protected boolean bIsLoadingMore;
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.gsx_list_superrecyclerview);
        try {
            mSuperRecyclerViewMainLayout =
                    a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_mainLayoutId,
                            R.layout.gsx_list_layout_abs_listview);
            mClipToPadding = a.getBoolean(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerClipToPadding, false);
            mMaxLength = a.getBoolean(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerMaxLength, false);
            mPadding = (int) a.getDimension(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerPadding, -1.0f);
            mPaddingTop =
                    (int) a.getDimension(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerPaddingTop, 0.0f);
            mPaddingBottom =
                    (int) a.getDimension(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerPaddingBottom, 0.0f);
            mPaddingLeft =
                    (int) a.getDimension(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerPaddingLeft, 0.0f);
            mPaddingRight =
                    (int) a.getDimension(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInt(R.styleable.gsx_list_superrecyclerview_gsx_list_recyclerScrollbarStyle, -1);
            mHeaderId = a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_layout_header, -1);
            mEmptyId =
                    a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_layout_empty,
                            R.layout.gsx_list_layout_empty);
            mErrorId =
                    a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_layout_error,
                            R.layout.gsx_list_layout_error);
            mMoreProgressId =
                    a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_layout_moreProgress,
                            R.layout.gsx_list_layout_list_load_more);
            mProgressId =
                    a.getResourceId(R.styleable.gsx_list_superrecyclerview_gsx_list_layout_progress,
                            R.layout.gsx_list_layout_loading);

            bEnableRefresh = a.getBoolean(R.styleable.gsx_list_superrecyclerview_gsx_list_enableRefresh, true);
            bEnableLoadMore = a.getBoolean(R.styleable.gsx_list_superrecyclerview_gsx_list_enableLoadMore, true);
    ...
    private void initView() {
        ...
        mRefreshLayout = (SwipeRefreshLayout) v.findViewById(R.id.gsx_list_layout_abs_listview_swipe_refresh);
        mRefreshLayout.setEnabled(false);

        mHeader = (ViewStub) v.findViewById(R.id.gsx_list_abs_list_view_header);
        if (mHeaderId > 0) {
        ...
        mLoadMore = (ViewStub) v.findViewById(R.id.gsx_list_abs_list_view_load_more);
        mLoadMore.setLayoutResource(mMoreProgressId);
        mLoadMoreView = mLoadMore.inflate();
//        mLoadMoreView.setVisibility(View.VISIBLE);

        mProgress = (ViewStub) v.findViewById(R.id.gsx_list_abs_list_view_progress);
        mProgress.setLayoutResource(mProgressId);
        mProgressView = mProgress.inflate();

        mError = (ViewStub) v.findViewById(R.id.gsx_list_abs_list_view_error);
        ...
        mEmpty = (ViewStub) v.findViewById(R.id.gsx_list_abs_list_view_empty);
        ...
        TextView header = (TextView) v.findViewById(R.id.gsx_list_abs_floating_header);
    ...
    protected void initRecyclerView(View view) {
        View recyclerView = view.findViewById(R.id.gsx_list_layout_abs_listview_lv);
        ...
        mInternalOnScrollListener = new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (layoutManager instanceof LinearLayoutManager) {
                    ...
                    Log.d("hh ", lastCompletelyVisibleItemPosition + ", " + lastVisibleItemPosition + ", " + lastVisibleItemPosition + ", " + totalItemCount);
