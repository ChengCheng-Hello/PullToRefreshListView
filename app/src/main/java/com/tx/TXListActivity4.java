...
import com.cc.myptrlibrary.TXListView4;
 ...
 */
public class TXListActivity4 extends FragmentActivity {

    private TXListView4<String> listView;
    ...
    public static void launch(Context context) {
        Intent intent = new Intent(context, TXListActivity4.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tx_activity_list4);
        ...
        listView = (TXListView4) findViewById(R.id.listView);
        ...
        listView.setOnReloadClickListener(new TXOnReloadClickListener() {
            ...
            public void onReloadClick() {
                Toast.makeText(TXListActivity4.this, "error ", Toast.LENGTH_SHORT).show();
    ...
    private void setLv() {
        listView.setOnPullToRefreshListener(new TXOnPullToRefreshListener() {
            ...
            public void onRefresh() {
                Toast.makeText(TXListActivity4.this, "onRefresh ", Toast.LENGTH_SHORT).show();
        ...
        listView.setOnLoadMoreListener(new TXOnLoadMoreListener() {
            ...
            public void onLoadMore() {
                Toast.makeText(TXListActivity4.this, "onLoadMore ", Toast.LENGTH_SHORT).show();
