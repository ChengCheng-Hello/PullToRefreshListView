 ...
 * same orientation as the layout you should wrap the child in a simple {@link android.widget.FrameLayout} so it can
 * receive the margin.
 */
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed,
        ...
        if (hasDividerBeforeChildAt(index)) {
            if (orientation == VERTICAL) {
                // UserAccount for the divider by pushing everything up
                params.topMargin = mDividerHeight;
            } else {
                // UserAccount for the divider by pushing everything left
